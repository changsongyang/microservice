package org.study.common.mq.message;
...
public class PMessage<T> {
    ...
    public PMessage(String topic, String tags, String key){
        this.topic = topic;
        this.tags = tags;
        this.key = key;
    }

    public PMessage(String topic, String tags, String key, T body){
        this.topic = topic;
        this.tags = tags;
        this.key = key;
        this.body = body;
    ...
    public void setMsgEvent(int msgEvent) {
